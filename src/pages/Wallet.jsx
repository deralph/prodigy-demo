...
export default function Wallet() {
  ...
  const handleDone = useCallback(({ type, amount, ref, id }) => {
    if (type === 'success') {
      setToast({ type: 'success', title: 'Wallet Funded Successfully!', message: `${fmt(amount)} has been credited to your wallet.`, sub: `Ref: ${ref}  ·  ID: ${id}` });
    } else {
  ...
  return (
    <div>
      <PageHeader title="Fund Management" subtitle="Wallet · Transactions · History" />
